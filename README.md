...
- **Keyboard-aware Landing navigation** — keyboard and synthesized activation of any Landing entry action moves focus into Create's brief field; keyboard About navigation moves focus to the Landing heading, where the next Tab reaches the hero action. Pointer entry and ordinary reload do not force a form or heading focus. The narrow heading box and its visible focus ring remain contained at 390 and 320 pixels.
