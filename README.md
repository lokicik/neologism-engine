...
> Held-out cold Auto check: from `web/`, `node e2e/heldout-cold-quality-audit.mjs` audits 105 production-path pages from 35 independent briefs and seeds plus twelve AI-workflow and nine recruiter-wording stress pages, gating full batches, structural quality, concept coverage, family similarity, exact-stem concentration, suffix leads, weak-Respell starvation, formatter/household/recruiter constructions, and cross-seed first-page spread.
