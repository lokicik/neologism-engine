...
> Archived on 2026-09-08. This is the earlier detailed README, preserved for historical reference. Use the [current project README](../../README.md) for setup and status. Historical claims and proposed work below are not new validation or an active roadmap.
