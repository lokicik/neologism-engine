...
/// tech tail marks a name the owner rejected. The strong-anchor bias tried
/// earlier was reverted — it made every page sound the same (Vault-/Craft-/
/// Nest-), which the owner rated worse. The "is this pairing coherent/tasteful"
/// judgment is the offline ceiling; it is handed to the LLM reranker instead.
