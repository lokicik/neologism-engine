#!/usr/bin/env python3
"""Run Phase 299 against a clean archive of the frozen committed core."""
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="phase299-") as temporary:
        clean_workspace = extract_workspace(repo, Path(temporary))
        shutil.copyfile(
            research / "probe.rs",
            clean_workspace / "core" / "examples" / "conceptnet_lattice_probe.rs",
        )
        if args.check_only:
