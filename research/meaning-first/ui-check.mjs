...
const out = resolve(root, 'research/meaning-first/artifacts')
await withBrowser(async (page) => {
  ...
  const option = page.getByRole('checkbox', { name: /Prioritize product meaning/ })
  ...
  assert.equal(exported.run.config.variant, 'semantic_pool')
